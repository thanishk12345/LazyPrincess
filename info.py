...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Mntgxo:<mntgxo>@cluster0.fbshstb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "lazy1")
...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', '-1002098875945'))
